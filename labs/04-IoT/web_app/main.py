...
YOUR_HASH_PASSWD = "YOUR_HASH_PASSWD" # YOUR_HASH_PASSWD

app = Flask(__name__)

# get the column names of the db
q = """
SELECT * FROM `PROJECT_ID.DATABASE_ID.weather-records` LIMIT 10
"""
...
def send_to_bigquery():
    if request.method == 'POST':
        ...
        # data["weather"] = ...
        # building the query
        q = """INSERT INTO `PROJECT_ID.DATABASE_ID.weather-records` 
        """
        names = """"""
        values = """"""
